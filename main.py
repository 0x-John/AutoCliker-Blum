...
# Название окна с игрой - Замените на свое, если возникает ошибка "Не найдено окна с заголовком:"
WINDOW_TITLE = "Blum"
# Процент целей для обработки (0.018 - примерно 130 звездочек за игру)
TARGET_PERCENTAGE = 0.018
